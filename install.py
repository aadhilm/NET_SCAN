...
def install_python_debian():
    ...
    run_command("sudo apt install -y python3-pip sqlitebrowser")
    run_command("pip3 install pyparsing six scapy networkx matplotlib psutil")
...
def install_python_arch():
    ...
    run_command("sudo pacman -S --noconfirm python-pip sqlitebrowser")
    run_command("pip3 install pyparsing six scapy networkx matplotlib psutil")
...
def install_python_fedora():
    ...
    run_command("sudo dnf install -y python3-pip sqlitebrowser")
    run_command("pip3 install pyparsing six scapy networkx matplotlib psutil")
